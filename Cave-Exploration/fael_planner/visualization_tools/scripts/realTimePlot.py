...
def exploration_data_callback(msg):
    ...
    explored_plane_volume = msg.exploredPlaneVolume
...
def listener():
    ...
    rospy.Subscriber("/exploration_data/explored_volume_traved_dist_time",
                     ExploredVolumeTravedDistTime, exploration_data_callback)
    rospy.Subscriber("/exploration_data/run_time", IterationTime,
                     iteration_time_callback)
