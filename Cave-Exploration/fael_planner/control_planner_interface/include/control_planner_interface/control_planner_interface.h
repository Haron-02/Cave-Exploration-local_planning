...
namespace interface
{
    ...
    public:
        ...
        ControlPlannerInterface(ros::NodeHandle &nh_private,
                                std::shared_ptr<PCIManager> &pci_manager);
        ...
        bool callForPlanner(const int &iteration_id,
        ...
        void executePath(const std::vector<control_planner_interface::Path> &path_segments, bool &success,
