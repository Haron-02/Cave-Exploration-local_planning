...
// using path_execution::PathExecution;
// using perception::Map2DManager;
// using preprocess::Preprocess;
// using topo_planner::TopoPlanner;
...
namespace fast_planner
{
  ...
  public:
    ...
    unique_ptr<Astar> path_finder_FAEL_;
    unique_ptr<TopologyPRM> topo_prm_;
    // TopoPlanner::Ptr topo_planner_;
    // PathExecution::Ptr path_execution_;
  ...
  private:
    ...
    // preprocess::Preprocess::Ptr preprocess_elements_;
