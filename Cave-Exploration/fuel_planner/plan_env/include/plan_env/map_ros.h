...
namespace fast_planner
{
  ...
  private:
    ...
    ros::Publisher map_local_pub_, map_local_inflate_pub_, esdf_pub_, map_all_pub_, map_inflate_pub_, unknown_pub_,
        map_free_pub_, update_range_pub_, depth_pub_;
    ros::Publisher local_cloud_pub_;  //  感知范围内的点云，用于可视化
